...
- **Icons:** generated by `scripts/generate-pwa-icons.mjs` from the emblem of the brand logo on the
  dark ground: `icons/icon-192.png`, `icon-512.png`, `icon-maskable-512.png` (80% safe zone),
  `icons/badge-96.png` (monochrome, Android status bar), `app/icon.png` (favicon), `app/apple-icon.png`.
  Manifest: standalone, portrait, `id: '/'`, brand dark `theme_color` / `background_color`.
