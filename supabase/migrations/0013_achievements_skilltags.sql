...
--
-- Skill tags are community-endorsed traits and are NOT part of the Community Skill Level (§9.5).
-- Achievements are OFFICIAL (issued by a verified organizer/admin - carries a verified issuer label)
-- or COMMUNITY CLAIMS (player-added, peer-endorsed, clearly labeled as not an official record, §9.4).
-- Tournament HISTORY (§49) is derived from `registrations` - no new table. Official achievements with
-- a division give the §50 anti-sandbagging historical signal real, non-invented evidence.
-- Apply via the Supabase SQL editor (same method as 0001–0012).
-- =============================================================================
