...
export const SKILL_BANDS = [
  ...
  },
  {
    ...
    label: 'Beginner',
    color: '#22c55e',
    blurb: 'Learning the rules and basic shots.',
  },
  {
    ordinal: 2,
    key: 'novice',
    label: 'Novice',
    color: '#14b8a6',
    blurb: 'Consistent rallies, developing strategy.',
  },
  {
    ordinal: 3,
    key: 'low_intermediate',
    label: 'Low Intermediate',
    color: '#3b82f6',
    blurb: 'Reliable serves, dinks and third shots.',
  },
  {
    ordinal: 4,
    key: 'high_intermediate',
    label: 'High Intermediate',
    color: '#8b5cf6',
    blurb: 'Controls pace, places shots, reads the game.',
  },
  {
    ordinal: 5,
    key: 'advanced',
    label: 'Advanced',
    color: '#f97316',
    blurb: 'Tournament-level power and shot selection.',
  },
  {
    ordinal: 6,
    key: 'pro',
    label: 'Pro',
    color: '#e11d48',
    blurb: 'Elite, competes at the highest level.',
  },
] as const;
