...
-- ---------- Verify ----------
select 'vouch_tables' as check, count(*) as n from information_schema.tables
  where table_schema = 'public'
    and table_name in ('vouches','vouch_revisions','vouch_comments','vouch_requests',
                       'player_skill_profiles','blocks','fraud_flags')
union all
