...
-- ---------- Verify ----------
select 'payments_table' as check, count(*) as n from information_schema.tables
  where table_schema = 'public' and table_name = 'payments'
union all
select 'payment_methods_col', count(*) from information_schema.columns
  where table_schema = 'public' and table_name = 'tournaments' and column_name = 'payment_methods'
union all
select 'payments_rls_policy', count(*) from pg_policies
